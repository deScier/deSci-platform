   ...
   ({ className, children, ...props }, ref) => (
      <Portal>
         ...
         <DialogPrimitive.Content
            ref={ref}
            className={cn(
               'top-auto left-auto right-0 bottom-0 translate-x-0 translate-y-0 rounded-t-2xl rounded-bl-none rounded-br-none max-w-full w-full',
               'fixed md:left-[50%] md:min-w-0 md:right-auto md:bottom-auto md:top-[50%] z-50 grid md:translate-x-[-50%] md:translate-y-[-50%] gap-6 bg-white p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg dark:border-slate-800 dark:bg-slate-950 overflow-y-auto max-h-[85vh] 2xl:max-h-[80vh]',
               className
            )}
            {...props}
         >
