export { SelectArticleType };
export type { SelectArticleTypeProps };

import { DropdownMenuSeparator } from '@/components/ui/dropdown-menu';
import { Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectTrigger } from '@/components/ui/select';
import { article_types_submit_article, articles_types_filter, ArticlesTypesFilter } from '@/mock/articles_types';
 ...
 */
const SelectArticleType: React.FC<SelectArticleTypeProps> = ({
  variant = 'filter',
  onValueChange,
