          ...
          {isSmallDesktop ? (
            <HoverCard>
              <HoverCardTrigger className="truncate cursor-pointer">
                <h6 className="text-sm md:text-base font-semibold text-secundary_blue-main truncate cursor-pointer">
                  {title}
                </h6>
              </HoverCardTrigger>
