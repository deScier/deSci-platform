      ...
      <React.Fragment>
         <footer className="bg-[#110838] grid md:grid-cols-4 justify-items-center md:gap-12 w-full h-fit py-14 px-6 md:py-14">
            ...
            <div className="grid gap-4 w-full content-start">
               ...
               <Link href={'https://api.whatsapp.com/send?phone=13035257908'} target="_blank" rel="noopener noreferrer" className="grid gap-1">
               ...
               <Link href={'mailto:publishing@descier.science'} className="grid gap-1">
                  <div className="flex items-center gap-3">
                     <EmailIcon className="w-4 h-4" />
                     <p className="text-sm text-neutral-white font-semibold select-none">E-mail</p>
                  </div>
                  <p className="text-sm text-neutral-white font-regular select-none hover:text-secundary-main cursor-pointer">publishing@descier.science</p>
               </Link>
            </div>
         </footer>
      </React.Fragment>
