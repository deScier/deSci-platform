    ...
    <React.Fragment>
      <div className="space-y-2">
        ...
        <p className="text-base">
          You can Connect with your MetaMask wallet. We operate on the Polygon network. Alternatively, you can Go to
          your dashboard and add your digital wallet there at any time.
        </p>
        <p className="text-sm text-neutral-gray">
          Note: The wallet created through this process will be on the Polygon network.
        </p>
      </div>
    </React.Fragment>
  );
